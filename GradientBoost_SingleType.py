...
# best: (P125L30, maxdepth=3)3000+, 
# CALLS (P70L30 maxdepth=4)2500-2750, 1750 
# CALLS (P70L30 maxdepth=3)2500-2750
# PUTS (P70L30 maxdepth=3) 1250-1500
ada = GradientBoostingClassifier(n_estimators=1500, max_depth=3, validation_fraction=0.1)
